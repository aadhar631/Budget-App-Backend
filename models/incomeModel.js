...
// Create a new Mongoose schema for the 'Income' collection
const IncomeSchema = new mongoose.Schema({
    ...
    // Define the 'type' field with String type, default value 'income'
    type: {
        type: String,
        default: "income"
    },
...
// Export the Mongoose model named 'Income' with the defined schema
